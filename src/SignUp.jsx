...
const SignUp = () => {
  ...
  return (
    ...
    <div className='flex  flex-col items-center mt-10 gap-5'>
      ...
      <form className='flex flex-col border-1 border-gray-300  w-1/2 p-8 py-7 items-center gap-3 rounded-xl mb-4 shadow-2xl '  onSubmit={handleSubmit}>
        <div className='w-[95%] '>
            <p className='text-md text-gray-700 font-semibold pb-3'>Full Name</p>
            <input className='border-1 border-gray-400 bg-gray-50 w-full  rounded-md py-2 px-3 focus:outline-none focus:border-black focus:border-1.8 duration-200' name="fullName" onChange={cha} type="text" placeholder='Enter your full name' value={formData.fullName}/>
            {errr.fullName && <p className='text-red-600'>{errr.fullName}</p>}
        </div>
        <div className='w-[95%] '>
            <p className='text-md text-gray-700 font-semibold pb-3'>Email</p>
            <div className='relative '>
              <input className='border-1 border-gray-400 bg-gray-50 w-full  rounded-md py-2 px-3 focus:outline-none focus:border-black pl-10' type="email" placeholder='Enter your email'name="email" onChange={cha} value={formData.email}/>
              <Mail className='absolute top-2.5 left-2 opacity-50 w-[5%] h-[50%]'/>
            </div>
        ...
        <div className='w-[95%] '>
            ...
            <div className='relative '>
              <input className=' border-1 border-gray-400 bg-gray-50 w-full h-[80%] rounded-md py-2 px-3 focus:outline-none focus:border-black pl-10' type={eye?"text":"password"}   placeholder='Enter your password ' name="password" onChange={cha} value={formData.password}/>
        ...
        <div className='w-[95%] '>
            ...
            <div className='relative'>
              ...
              <input className='border-1 border-gray-400 bg-gray-50 w-full  rounded-md py-2 px-3 focus:outline-none pl-10 focus:border-black' 
        ...
        <p className='text-gray-700 font-semibold'>Already have an account? <Link to="/login" className='text-purple-700'>Sign in here</Link></p>
